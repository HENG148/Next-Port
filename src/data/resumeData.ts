...
interface SkillItem {
  icon: React.ElementType; // Assuming you're using React and importing the icons as components
  name: string;
}
...
// Combine all the sections into one data type
interface Data {
  about: About;
...
const data: Data = {
  ...
  experience: {
    ...
    items: [
      {
        company: 'Giant Focus Inc.',
        position: 'Web Front-end Developer',
        duration: '2022-May - 2022-September',
      },
    ],
  },
  education: {
    ...
    items: [
      ...
      {
        institution: 'Above & Beyond School',
      ...
      {
        institution: 'Chhong Zheng High School',
        degree: 'High School',
        duration: '2019 - 2021',
      },
      {
